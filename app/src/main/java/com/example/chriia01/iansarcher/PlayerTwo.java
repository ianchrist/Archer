...
public class PlayerTwo {
    ...
    // Constructor
    public PlayerTwo(Context context, int screenX, int screenY){
        ...
        // Center screen on top
        x = screenX / 2 - 58;
        y = 20;

        // Initialize the bitmap
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.playershiptwo);
